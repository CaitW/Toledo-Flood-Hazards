var app = (function() {
    ...
    // Map.js //
    ////////////
    var serviceURL, siteBounds, map, satellite, toner, terrain, basemap, basemapList, currentBasemap, depth, stormWater, allLayersList;
    /////////////
    // Init.js //
    /////////////
    ...
    function init() {
        ...
        serviceURL = "http://216.165.135.4:6080/arcgis/rest/services/NOAA_ECON/duluth_mapservice_test/MapServer";
        ...
        depth = new L.esri.dynamicMapLayer(serviceURL, {
            className: '2',
            layers: [depthGridCurrent],
